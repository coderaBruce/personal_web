...
console.log(domainByTrait);
  ...
  var cell = svg.selectAll(".cell")
    ...
    .enter().append("g")
      ...
      .each(plot);
  	  // cell.on("click", function(){console.log("asdf");}); 
  ...
  // 选中所有9个rect，添加mouseover事件
  // cell.selectAll("rect")
			// .on("mouseover", function(){
								// console.log("in");	
								// // 这里只能用style 不能用attr, 不知道为什么
								// d3.select(this)
  ...
  function plot(p) {
    ...
    cell.append("rect")
		...
		.on("click", function(){
			// d3.selectAll("div.myCss02").remove();
			console.log("remove")	
			// console.log(d3.select("div.myCss02").isActive());
			lassoDraw(p.x, p.y);
