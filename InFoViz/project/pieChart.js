...
// 1. Margin;
var outerRadius = 200, innerRadius = 0;
...
var data = d3.nest()
			  .key(function(d) { console.log(d.Category);return d.Category; })
			  .rollup(function(v) { return d3.mean(v, function(g) {return g["Expense ratio"]; }) })
			  .entries(data);

console.log(data);
// 5.2 transform chart
svg = d3.select("div.myCss01").append("svg")
    .attr("width", width)
    .attr("height", height)
  .append("g")
